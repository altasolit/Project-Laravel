...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <form action="{{ route('fasilitas.update', $fasilitas->id) }}" method="post" class="row g-3 mt-3" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="mb-3 ms-3">
                    ...
                    <div class="mb-3 ms-3">
                         @if ($fasilitas->gambar)
                            <p>Gambar saat ini:</p>
                            <img src="{{ asset('storage/' . $fasilitas->gambar) }}" width="150">
                        @endif
