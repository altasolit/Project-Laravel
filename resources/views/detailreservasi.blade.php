...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
    ...
    <main class="container mt-4">
      <section class="row">
        ...
        <img src="/IMG/singgle bed 2.jpg" height="250" width="300" class="rounded float-start" alt="...">
        </article>
  ...
  <input type="date" class="form-control" placeholder="Tanggal" aria-label="Tanggal" aria-describedby="addon-wrapping">
              </div>
              <br>
              <div class="input-group flex-nowrap">
