    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Gabung | Daftar</a>
          </li>
        </ul>
      </div>
      <style>
...
.navbar {
    background: linear-gradient(to bottom, rgb(0, 0, 0), rgba(0, 0, 0, 0.29)); /* Gradasi dari hitam pekat ke transparan */
    backdrop-filter: blur(100px); /* Blur latar belakang */
    /* box-shadow: 0px 4px 6px rgba(0, 0, 0, 0); Bayangan lembut */
 ...
 <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/bg-home.jpeg" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="var(--bs-secondary-color)"/>
      </div>
    </div>
 </div>
    ...
    <div class="col-12 d-flex justify-content-between align-items-center">
      ...
      <div id="circle-slider" class="d-flex overflow-hidden flex-nowrap" style="flex: 1;">
        <div class="d-flex" style="transition: transform 0.3s ease;">
          ...
          <!-- Tambahkan lebih banyak lingkaran -->
        </div>
      </div>
