                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                        <div class="text-center mb-6 d-flex flex-column gap-2">
                            <!--heading-->
                            <h2 class="mb-0 mx-xl-8 h1" style="color: black;">Our rooms . <span
                                    style="color: grey;">Relax, and enjoy your vacation</span></h2>
                            <!--para-->
            ...
            <footer class="py-5 bg-dark text-secondary">
                <div class="container text-center">
                    <div class="row justify-content-center mb-4">
                        <div class="col-lg-6">
                            <img src="{{ asset('IMG/logo.png') }}" class="navbar-brand" href="#" width="40px"
                                height="40px" style="filter: brightness(0) invert(1);">
                            <p class="text-light">
                                Stay inspired. With modern facilities, seamless service, and thoughtful amenities, we make
                                every business trip feel effortless.
                            </p>
                        </div>
                    </div>
                    <div class="row justify-content-center mb-4">
                    ...
                    <div class="text-center pt-3 border-top border-secondary">
                        <small class="text-secondary">© <span id="year"></span> Luxury hotel. All Rights
                            Reserved.</small>
