...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <form action="{{ route('kamar.update', $room->id) }}" method="post" class="row g-3 mt-3" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="mb-3 ms-3">
                        <label class="form-label fw-bold">Nomor Kamar</label>
                        <input type="text" name="nomor_kamar" value="{{ $room->nomor_kamar }}" class="form-control">
                    </div>
                    <div class="mb-3 ms-3">
                    ...
                    <div class="mb-3 ms-3">
                        ...
                        <input type="number" name="harga"  value="{{ $room->harga }}" class="form-control" required>
                    </div>
                    <div class="mb-3 ms-3">
                    ...
                    <div class="mb-3 ms-3">
                        ...
                        <textarea name="deskripsi" class="form-control" required>{{ $room->deskripsi }}</textarea>
                    </div>
                    <div class="mb-3 ms-3">
                         @if ($room->gambar)
                            <p>Gambar saat ini:</p>
