                ...
                <a class="nav-link" href="#">Link</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">Pilihan Kamar</a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#VIP"><i><b><span style="color :gold">
                                                    VIP</span></b></i> Room</b></a></li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2" style="color:#FFB200;"><b>VIP</b></strong>
                        <h3 class="mb-0">Cozy & Private</h3>
                        <div class="mb-1 text-body-secondary">Kamar single dengan desain minimalis dan nyaman cocok
                            untuk Anda yang mencari ketenangan dan privasi</div>
                        <p class="card-text mb-auto"></p>
                        <a href="#" class="icon-link gap-1 icon-link-hover stretched-link">
                            Continue reading
                        </a>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="IMG/rek 1.jpg" class="bd-placeholder-img" width="250" height="250"
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2" style="color:#FFB200;"><b>VIP</b></strong>
                        <h3 class="mb-0"><b>Modern Simplicity</b></h3>
                        <div class="mb-1 text-body-secondary">Kamar bergaya modern dengan suasana hangat dan nyaman
                            Ideal untuk solo traveler</div>
                        <p class="mb-auto"></p>
                        <a href="#" class="icon-link gap-1 icon-link-hover stretched-link">
                            Continue reading
                            <svg class="bi">
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="IMG/rek 2.jpg" class="bd-placeholder-img" width="250" height="250"
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2" style="color:#FFB200;"><b>VIP</b></strong>
                        <h3 class="mb-0">Twin Room</h3>
                        <div class="mb-1 text-body-secondary">Luas, modern, dan elegan. Dilengkapi dengan fasilitas
                            premium untuk kenyamanan maksimal</div>
                        <p class="card-text mb-auto"></p>
                        <a href="#" class="icon-link gap-1 icon-link-hover stretched-link">
                            Continue reading
                        </a>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="IMG/rek 3.jpg" class="bd-placeholder-img" width="250" height="250"
                            role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice"
                            focusable="false">
                        <title>Placeholder</title>
                        <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%" fill="#eceeef"
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2" style="color:#FFB200;"><b>VIP</b></strong>
                        <h3 class="mb-0">Twin Room</h3>
                        <div class="mb-1 text-body-secondary">Nyaman untuk dua orang, dengan desain stylish dan
                            fasilitas lengkap</div>
                        <p class="mb-auto"></p>
                        <a href="#" class="icon-link gap-1 icon-link-hover stretched-link">
                            Continue reading
                            <svg class="bi">
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="IMG/rek 4.jpg" class="bd-placeholder-img" width="250" height="250"
                            xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail"
                            preserveAspectRatio="xMidYMid slice" focusable="false">
                        <title>Placeholder</title>
                        <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%" fill="#eceeef"
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2" style="color:#FFB200;"><b>VIP</b></strong>
                        <h3 class="mb-0">Executive Suite</h3>
                        <div class="mb-1 text-body-secondary">Kemewahan dalam setiap detail. Nikmati ruang luas dengan
                            pemandangan indah</div>
                        <p class="card-text mb-auto"></p>
                        <a href="#" class="icon-link gap-1 icon-link-hover stretched-link">
                            Continue reading
                        </a>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="IMG/rek 5.jpg" class="bd-placeholder-img" width="250" height="250"
                            role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice"
                            focusable="false">
                        <title>Placeholder</title>
                        <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%" fill="#eceeef"
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2" style="color:#FFB200;"><b>VIP</b></strong>
                        <h3 class="mb-0">Luxury Suite</h3>
                        <div class="mb-1 text-body-secondary">Gabungan sempurna antara kenyamanan dan kemewahan, ideal
                            untuk pengalaman menginap eksklusif</div>
                        <p class="mb-auto"></p>
                        <a href="#" class="icon-link gap-1 icon-link-hover stretched-link">
                            Continue reading
                            <svg class="bi">
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="IMG/rek 6.jpg" class="bd-placeholder-img" width="250" height="250"
                            xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail"
                            preserveAspectRatio="xMidYMid slice" focusable="false">
                        <title>Placeholder</title>
                        <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%" fill="#eceeef"
                        ...
                        <div class="col-md-4 d-flex justify-content-center">
                            <div class="card" style="width: 20rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Strike dengan gaya di tempat bowling mewah kami! Nikmati
                                        pengalaman bermain yang nyaman dan elegan</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex justify-content-center">
                            <div class="card" style="width: 20rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Nikmati relaksasi di kolam renang kami Sempurnakan liburan
                                        Anda di tepi kolam</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex justify-content-center">
                            <div class="card" style="width: 20rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Rasakan ketenangan dan kenyamanan di sauna eksklusif kami.
                                        Relaksasi tingkat premium menanti</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 d-flex justify-content-center">
                                    <div class="card" style="width: 20rem;">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title">Spa</h5>
                                            <p class="card-text">Rasakan relaksasi total dengan perawatan spa eksklusif
                                                kami. Nikmati pijat menenangkan, aroma terapi, dan suasana damai yang
                                                menyegarkan pikiran dan tubuh.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
